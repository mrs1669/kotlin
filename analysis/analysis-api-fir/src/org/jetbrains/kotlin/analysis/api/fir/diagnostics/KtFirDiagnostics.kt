...
sealed interface KtFirDiagnostic<PSI : PsiElement> : KtDiagnosticWithPsi<PSI> {
    ...
    interface DataClassConsistentCopyAndInconsistentCopyAreIncompatibleAnnotations : KtFirDiagnostic<KtAnnotationEntry> {
        override val diagnosticClass get() = DataClassConsistentCopyAndInconsistentCopyAreIncompatibleAnnotations::class
    }

    interface DataClassConsistentCopyAndInconsistentCopyAreRedundant : KtFirDiagnostic<KtAnnotationEntry> {
        override val diagnosticClass get() = DataClassConsistentCopyAndInconsistentCopyAreRedundant::class
    }
