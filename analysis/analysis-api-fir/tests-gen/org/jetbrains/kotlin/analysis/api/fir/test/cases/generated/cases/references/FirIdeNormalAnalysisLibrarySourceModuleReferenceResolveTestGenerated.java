...
public class FirIdeNormalAnalysisLibrarySourceModuleReferenceResolveTestGenerated extends AbstractReferenceResolveTest {
  ...
  public class TypeAlias {
    ...
    public void testAllFilesPresentInTypeAlias() {
      KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/referenceResolve/typeAlias"), Pattern.compile("^([^.]+)\\.kt$"), null, true, "withErrors");
    }
    ...
    public class MissingDependency {
      ...
      public void testAllFilesPresentInMissingDependency() {
        KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("analysis/analysis-api/testData/referenceResolve/typeAlias/missingDependency"), Pattern.compile("^([^.]+)\\.kt$"), null, true, "withErrors");
      }
