...
import org.jetbrains.kotlin.test.frontend.fir.handlers.FirDiagnosticsHandler//NotDisablingNextSteps
...
> TestConfigurationBuilder.commonConfigurationForJsCodegenTest(
    ...
    firHandlersStep {
        useHandlers(::FirDiagnosticsHandler)//NotDisablingNextSteps)
    }
